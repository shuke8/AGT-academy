...
import sea from '../images/avatars/sea.jpg'
import scada from '../images/avatars/scada.png'
...
const days = [
  {
    ...
    speakers: [
     {
        name: 'Scada',
        role: 'Real-time monitoring and control system.',
        image: scada,
        link: "https://youtu.be/yVBvn_pI4Ts",
      },
         {
        name: 'Scada',
        role: 'Real-time monitoring and control system.',
