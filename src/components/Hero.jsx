...
import TestModal from '@/components/modalVideo'
//
  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Unlock your potential in the energy industry with the comprehensive
        training and expert guidance offered by Asia Trans Gas Academy.
      </p>
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          Company has friendly and long-term cooperation with these companies:
        </p>
        <ul
          role="list"
